...
public class CustomerFinalOrders {
    ...
    public CustomerFinalOrders(String ownerId, String dishId, String dishName, String dishPrice, String dishQuantity, String randomUID, String totalPrice, String userId) {
        OwnerId = ownerId;
        DishId = dishId;
        DishName = dishName;
        DishPrice = dishPrice;
