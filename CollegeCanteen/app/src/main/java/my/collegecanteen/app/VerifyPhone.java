...
public class VerifyPhone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        phonenumber = getIntent().getStringExtra("phonenumberu").trim();

        sendverificationcode(phonenumber);
        entercode = (EditText) findViewById(R.id.codeu);
        txt = (TextView) findViewById(R.id.text);
        Resend = (Button) findViewById(R.id.Resendotpu);
        fAuth = FirebaseAuth.getInstance();
        verify = (Button) findViewById(R.id.Verifyu);
                ...
                .addOnCompleteListener(VerifyPhone.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(VerifyPhone.this, "Mobile Number Verified Successfully\nNow You can Login ", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(VerifyPhone.this,Signin_page.class);
