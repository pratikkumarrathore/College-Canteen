...
public class DeliveryVerifyPhone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        phonenumber = getIntent().getStringExtra("phonenumberd").trim();

        sendverificationcode(phonenumber);
        entercode = (EditText) findViewById(R.id.coded);
        txt = (TextView) findViewById(R.id.text);
        Resend = (Button) findViewById(R.id.Resendotpd);
        fAuth = FirebaseAuth.getInstance();
        verify = (Button) findViewById(R.id.Verifyd);
                ...
                .addOnCompleteListener(DeliveryVerifyPhone.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(DeliveryVerifyPhone.this, "Mobile Number Verified Successfully\nNow You can Login ", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(DeliveryVerifyPhone.this,Signin_page.class);
